...
export default function QuotationPreview({ quotation, settings }) {
  ...
  return (
    <div className="quotation-doc-wrapper w-full overflow-x-auto pb-4">
      <div className="quotation-doc min-w-[580px] sm:min-w-0" id="quotation-print-area">
          ...
          return (
            <section key={section.id || sIdx} className="quotation-doc__section">
              ...
              <div className="table-wrap overflow-x-auto w-full">
                <table className="quotation-doc__table min-w-[550px] sm:min-w-0">
                  <thead>
                    <tr>
                      <th>#</th>
        ...
        {activeCharges.length > 0 && (
          <section className="quotation-doc__charges">
            ...
            <div className="table-wrap overflow-x-auto w-full">
              <table className="quotation-doc__table quotation-doc__table--compact min-w-[300px]">
                <tbody>
                  {activeCharges.map((c) => (
                    <tr key={c.key}>
